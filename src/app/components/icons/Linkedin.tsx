...
export default function Linkedin({ width = 24, height = 24, className = '', fillColor = "currentColor" }: LinkedinProps) {
    return (
        <svg
            width={width}
            height={height}
